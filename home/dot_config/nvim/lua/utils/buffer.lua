...
--
-- This module can be loaded with `local buffer_utils = require "utils.buffer"`
--
-- @module utils.buffer
-- @copyright 2022
...
local function unique_path(bufnr)
  return require('utils.status.provider').unique_path() { bufnr = bufnr } .. fnamemodify(bufinfo(bufnr).name, ':t')
end
